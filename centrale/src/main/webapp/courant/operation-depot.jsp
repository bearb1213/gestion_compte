                ...
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h3 class="card-title mb-0">
                            <i class="fas fa-money-bill-wave me-2"></i>Effectuer un Dépôt
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <c:if test="${not empty compte}">
                            ...
                            <form action="operation" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="montant" class="form-label">Montant du Dépôt (DH) *</label>
                                    <input type="number" class="form-control" id="montant" name="montant" 
                                           step="0.01" min="0.01" required placeholder="Entrez le montant">
                                    <div class="form-text">Le montant doit être supérieur à 0</div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-check me-1"></i>Confirmer le Dépôt
                                    </button>
                                </div>
                            </form>
                        </c:if>
