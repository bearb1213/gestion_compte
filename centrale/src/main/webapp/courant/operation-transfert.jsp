                    ...
                    <div class="card-body">
                        ...
                        <c:if test="${not empty compte}">
                            <div class="alert alert-info">
                                <h6><i class="fas fa-info-circle me-1"></i>Compte Source :</h6>
                            ...
                            <form action="operation" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="toNumeroCompte" class="form-label">Compte Destinataire *</label>
                                    <input type="text" class="form-control" id="toNumeroCompte" name="toNumeroCompte" 
                                           required placeholder="Numéro du compte destinataire">
                                </div>

                                <div class="mb-3">
                                    <label for="montant" class="form-label">Montant du Transfert (DH) *</label>
                                    <input type="number" class="form-control" id="montant" name="montant" 
                                           step="0.01" min="0.01" required placeholder="Entrez le montant">
                                    <div class="form-text">Le transfert peut utiliser le découvert autorisé</div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-info">
                                        <i class="fas fa-check me-1"></i>Confirmer le Transfert
                                    </button>
                                </div>
                            </form>
                        </c:if>
